...
public class TaskEntry extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myadapter=new ArrayAdapter<String>(TaskEntry.this,android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.names));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.task_entry, menu);
        return true;
    }
